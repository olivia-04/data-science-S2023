...
- I notice that as carat increases, price generally does too which isn't surprising. However, I would expect the trend of increase to be more linear instead of logarithmic. 
...
I noticed that while the visual does show every variable, it is not very effective in conveying information. 
This is because all of the symbols overlap with one another to the point that you cannot see the cut of most of them. 
