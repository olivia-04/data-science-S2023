...
**Observations**: - Write your observations here! - I noticed that most
of the distinctness values are ‘3’, and the least by a wide margin are
‘1’. I also noticed that the mean velocities from the 2 and 3
distinctness values are very close, while the mean velocity from
distinctness value 3 is comparitively far off.

- Why might your table differ from Michelson’s?
  - Perhaps Michelson wanted to stick to 5 significant figures for
    clarity, while my table has 7 significant figures.
...
of his error is less than the true error.

- Make a quantitative comparison between Michelson’s uncertainty and his
  error.
  - Michelson’s uncertainty was about 100.542 km/s away from the actual
    error.
...
**Observations**: Similarities - The real and simulated data has similar
locations for peaks and drops. - The real and simulated data have
similar amounts of data spread - Both data sets peak at around the same
value

Differences - The real data has more intense peaks and drops than the
simulated data. - The simulated data stays closer to Michelson’s
estimate. - The Real data peaks at a lower value than the simulated
data.
...
Velocity in a Vacuum vs. Date - Temperatures in a singular day vary more
than I thought they would, but still are of similar values. - There may
be a loose correlation between temperature and velocity

Velocity in a Vacuum Count/Distinctness - Higher velocity measurements
tend to be 2 and 3 level distinctness. - 1 is the least common
distinctness value

Velocity in a Vacuum vs. Temperature. - The peak velocity measurement
occurs in the middle of the temperature values - However, the lowest
velocity measurement occurs at the lower end of the temperature range
