...
-   Document your observations here.
    -   The largest confidence interval of median household income is within Nantucket 5 person families.
    -   Suffolk County has similar median household incomes between family sizes.
...
-   What does this *overall* trend tell you about the relative ease of studying small vs large counties?
    -   Large counties are easier to study than small counties, as the former's SE is smaller
...
-   Bristol County seems to have the highest median incomes, especially among 5 person families. However, the county has the most SE between the family sizes.
-   Among all the counties, 2 person families have the lowest median income
-   In Washington County 6 person families have the highest median income, which is not true for any of the other counties
-   In Providence and Kent Counties, 4 person families have the highest median income
-   In Bristol and Newport counties, 5 person families have the highest median income
