...
-   You chose a correct value of `stat(x, y)` when `x, y` is *outside*
    ...
    -   I chose 0, as it represents that the point is outside of the
        circle thus no 'points' are earned towards the pi calculation.
-   You chose a correct value of `stat(x, y)` when `x, y` is *inside*
    the circle. Why did you choose this value?
    -   I chose 4, as the above equation represents the proportion of
        points inside the circle as multiplied by 4
...
-   Comment on the width of your CI(s). Would your estimate of $\pi$ be
    ...
    rocket into orbit)? It would be good enough as a rough estimate
-   What would be a *valid* way to make your CI more narrow?
    -   A valid way to make your CI more narrow would be to increase
        your sample size. This would mean the interval bounds are
        divided by a higher sqrt of n, and thus will be smaller in their
